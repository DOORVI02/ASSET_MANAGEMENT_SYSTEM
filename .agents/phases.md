...
- [ ] Documentation can be followed from a clean environment. `supabase/RUNBOOK.md` now exists to test this against, but the test itself (someone unfamiliar with this session actually following it from scratch) hasn't been performed.
